...
- [outlookCalendarManager.gs](outlookCalendarManager.gs) - Outlook カレンダーの取得・作成・更新・削除
...
4. 2で入力したリクエストURLの右にある「▷Run query」をクリックし、下に緑色で「OK - 200 - xxxms」などと表示されれば、OK。さらに下の「Response preview」に自分のカレンダーの一覧が出るので、nameパラメータから、予定を管理したいカレンダーのidパラメータの内容をメモする。

### [ステップ3] Google Apps Scriptの準備
